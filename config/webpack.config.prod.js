    ...
    rules: [
      ...
      },
      {
        ...
        oneOf: [
          ...
          // Process TS with awesome-typescript-loader
          // All files with a '.ts' or '.tsx' extension will be handled by 'awesome-typescript-loader'.
          {
            test: /\.tsx?$/,
            //loader: require.resolve("awesome-typescript-loader"), // Sometime this plugin has a suddenly error.
              ...
              Object.assign(
                {
                  ...
                  use: [
                    {
                      loader: 'css-loader?importLoaders=1&-raw',
                      options: {
                        importLoaders: 1,
                        minimize: true,
                        sourceMap: shouldUseSourceMap,
              ...
              Object.assign(
                {
                  fallback: require.resolve('style-loader'),
                  use: [
                    //'css-loader?modules&importLoaders=1&localIdentName=[hash:base64:5]&-raw!sass-loader',
                    {
                      loader: require.resolve('css-loader'),
                      options: {
                        importLoaders: 1,
